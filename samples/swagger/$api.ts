...
import { Methods as Methods2 } from './pet/_petId@number/uploadImage/index'
import { Methods as Methods3 } from './pet/findByStatus/index'
import { Methods as Methods4 } from './store/inventory/index'
import { Methods as Methods5 } from './store/order/index'
import { Methods as Methods6 } from './store/order/_orderId@number/index'
import { Methods as Methods7 } from './user/index'
import { Methods as Methods8 } from './user/_username@string/index'
import { Methods as Methods9 } from './user/createWithArray/index'
import { Methods as Methods10 } from './user/createWithList/index'
import { Methods as Methods11 } from './user/login/index'
