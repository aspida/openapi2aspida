...
exports.default = (function (configs) {
    return getConfig_1.default(configs).map(function (config) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, baseURL, types, files;
            ...
            switch (_b.label) {
                case 0:
                    if (!fs_1.default.existsSync(config.output)) {
                        ...
                        console.log("fatal: destination path '" + config.output + "' already exists and is not an empty directory.");
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, buildTemplate_1.default(config)];
                case 1:
                    _a = _b.sent(), baseURL = _a.baseURL, types = _a.types, files = _a.files;
                    writeRouteFile_1.default({
                        config: {
                            input: config.output,
                            baseURL: baseURL,
